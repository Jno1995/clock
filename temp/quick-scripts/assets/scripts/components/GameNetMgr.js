(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/components/GameNetMgr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '8ee42q8q5RCO5Xlaun93hyM', 'GameNetMgr', __filename);
// scripts/components/GameNetMgr.js
...
cc.Class({
    ...
    initEventHandlers: function initEventHandlers() {
        ...
        cc.vv.gameEvent.addEventHandler("_PACKET_104", function (data) {
            ...
            if (data['resultCode'] == 0) {
                ...
                if (cc.vv.wxHelper._queryData != null) {
                    ...
                    if ("undefined" !== typeof data && "undefined" !== typeof data.inviterId && "undefined" !== typeof data.inviterName) {
        ...
        cc.vv.gameEvent.addEventHandler("_PACKET_240", function (data) {
            ...
            console.log(typeof fixlan === "undefined" ? "undefined" : _typeof(fixlan));
        ...
        cc.vv.gameEvent.addEventHandler("_PACKET_246", function (data) {
            ...
            console.log(typeof fixconst === "undefined" ? "undefined" : _typeof(fixconst));
        ...
        cc.vv.gameEvent.addEventHandler("_PACKET_1011", function (data) {}, this);
        ...
        cc.vv.gameEvent.addEventHandler("_PACKET_1020", function (data) {
            ...
            console.log(data);
            for (var i = 0; i < data.goldMatchInfoLen; i++) {
        ...
        cc.vv.gameEvent.addEventHandler("_PACKET_1022", function (data) {
            ...
            for (var i = 0; i < data.goldMatchLen; i++) {
    ...
    // 操作结果
    doOptResult: function doOptResult(data) {
    ...
    doKAIJIN: function doKAIJIN(data) {
    ...
    doBUHUA: function doBUHUA(seatIndex, huas, bupais, kaiju) {
    ...
    doCHI: function doCHI(seatIndex, pai1, pai2, pai3) {
    ...
    doGANG: function doGANG(seatIndex, pai, ag) {
    ...
    doANGANG: function doANGANG(seatIndex, pai) {
    ...
    doJIAGANG: function doJIAGANG(seatIndex, pai) {
    ...
    doDA: function doDA(seatIndex, pai) {
    ...
    doTING: function doTING(seatIndex, pai) {
    ...
    // 玩家执行命令
    sendPlayerCmdExcute: function sendPlayerCmdExcute(seatIndex, cmdcode, mjid1, mjid2, chiIndex, choice) {
    ...
    // 响应解散房间操作
    sendVoteDisband: function sendVoteDisband(isAgree) {
        var pw = new PacketWriter();
    ...
    // 解散房间
    sendDisband: function sendDisband() {
        var pw = new PacketWriter();
    ...
    // 后台切回前台，尝试重连逻辑服务器
    tryReconnectLogicServer: function tryReconnectLogicServer() {
    ...
    onRequestPlayerInfoEvent: function onRequestPlayerInfoEvent(playerId) {
