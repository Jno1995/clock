(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/components/GuideManage.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '56ef0DEl5dM0qKgvPIA6kFS', 'GuideManage', __filename);
// scripts/components/GuideManage.js
...
cc.Class({
    ...
    statics: {
        ...
        checkGuide: function checkGuide() {
            // TODO: 从服务器获取引导信息
            if (cc.vv.myself.guideStep == 0) {
                //玩家从未开始过新手引导
                this.curStepId = 0;
                cc.vv.utils.createPrefabByUrl(cc.vv.const.URL_GUIDE_MATCH_GAME);
            }
            if (cc.vv.myself.guideStep == 1) {
                //玩家在新手引导中到达了比赛结算分享阶段
                this.curStepId = 13;
            }
            if (cc.vv.myself.guideStep == 2) {
                //玩家完成了新手引导
                this.curStepId = 20;
            }
        ...
        // 完成一步引导
        doneGuideStep: function doneGuideStep(step) {
            // TODO: 告诉服务器哪步引导完成了
        ...
        // 初始化引导配置
        initConfigure: function initConfigure() {
        ...
        onSendGuideStepEvent: function onSendGuideStepEvent(step) {
        ...
        // 设置引导配置
        // 01_介绍比赛券
        setConfigure_0: function setConfigure_0() {
            var self = this;
        ...
        setConfigure_1: function setConfigure_1() {
            var self = this;
        ...
        //03_引导点击报名
        setConfigure_2: function setConfigure_2() {
            var self = this;
            ...
            dataObj.nextCallFunc = function () {
                ...
                cc.vv.utils.showDialogOKCancel(cc.vv.lan.MATCH_LAN[7].format(15), function () {}, function () {}, true, cc.vv.enum.EnumLabelHorizontalAlign.LEFT, function () {
        ...
        //04_弹出报名成功弹窗
        setConfigure_3: function setConfigure_3() {
            var self = this;
        ...
        //05_对局须知高亮
        setConfigure_4: function setConfigure_4() {
            var self = this;
        ...
        //06_引导点击进入比赛
        setConfigure_5: function setConfigure_5() {
            var self = this;
        ...
        //07_玩家进入房间匹配比赛
        setConfigure_6: function setConfigure_6() {
            var self = this;
        ...
        //08_引导进入最后一局比赛
        setConfigure_7: function setConfigure_7() {
            var self = this;
            var widget = cc.find('Canvas/guide_mj_battle_node/guideNode');
        ...
        //09_引导玩家点击抢金
        setConfigure_8: function setConfigure_8() {
            var self = this;
        ...
        // 10_引导玩家点击回合结算确定按钮
        setConfigure_9: function setConfigure_9() {
            var self = this;
        ...
        //11_引导玩家点击挑战成功返回大厅按钮
        setConfigure_10: function setConfigure_10() {
            var self = this;
        ...
        setConfigure_11: function setConfigure_11() {
            var self = this;
        ...
        setConfigure_12: function setConfigure_12() {
            var self = this;
        ...
        //14_引导玩家点击大厅中余额提现窗口
        setConfigure_13: function setConfigure_13() {
            var self = this;
        ...
        //15_引导玩家点击提现界面提现按钮
        setConfigure_14: function setConfigure_14() {
            var self = this;
        ...
        //16_提现教程  教程部分高亮
        setConfigure_15: function setConfigure_15() {
            var self = this;
        ...
        //17_提现教程关注公众号按钮高亮
        setConfigure_16: function setConfigure_16() {
            var self = this;
        ...
        setConfigure_17: function setConfigure_17() {
            var self = this;
        ...
        setConfigure_18: function setConfigure_18() {
        ...
        //20_引导玩家进行真实报名
        setConfigure_19: function setConfigure_19() {
            var self = this;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=GuideManage.js.map
