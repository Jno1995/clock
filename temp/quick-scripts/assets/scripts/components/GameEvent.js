(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/components/GameEvent.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ebbb1FA14JDHrvKF1yrPhTm', 'GameEvent', __filename);
// scripts/components/GameEvent.js
...
var GameEvent = {
    ...
    addEventHandler: function addEventHandler(event, fn, target) {
    ...
    removeEventHandler: function removeEventHandler(event, target) {
    ...
    dumpEventHandlers: function dumpEventHandlers() {
        ...
        for (var evt in this.handlers) {
            ...
            for (var tar in this.handlers[evt]) {
                console.log("  --" + (typeof tar === 'undefined' ? 'undefined' : _typeof(tar)) + " " + _typeof(this.handlers[evt][tar.__instanceId]));
            }
        }
