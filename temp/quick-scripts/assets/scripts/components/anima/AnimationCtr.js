(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/components/anima/AnimationCtr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '67753jaJBBMHLSzPfXSQEp2', 'AnimationCtr', __filename);
// scripts/components/anima/AnimationCtr.js
...
cc.Class({
    ...
    onFinished: function onFinished(event) {
        ...
        if (this.animation.node.name === "game_log") {
            var progressNode = cc.find("Canvas/res_load_progressBar");
            cc.WXHelper.downloadAllResources(progressNode, function (node, downloadProgress) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=AnimationCtr.js.map
